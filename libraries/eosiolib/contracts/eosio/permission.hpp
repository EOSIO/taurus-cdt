...
namespace eosio {
   namespace internal_use_do_not_use {
      extern "C" {
         __attribute__((import_name("check_transaction_authorization"))) int32_t check_transaction_authorization(const char*,  uint32_t,
                                          const char*, uint32_t,
                                          const char*, uint32_t);
         __attribute__((import_name("check_permission_authorization"))) int32_t check_permission_authorization( uint64_t, uint64_t,
                                                 const char*, uint32_t,
                                                 const char*, uint32_t,
                                                 uint64_t);
         __attribute__((import_name("get_permission_last_used"))) int64_t get_permission_last_used(uint64_t, uint64_t);

         __attribute__((import_name("get_account_creation_time"))) int64_t get_account_creation_time(uint64_t);
      }
   }
