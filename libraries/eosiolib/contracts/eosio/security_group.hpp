...
extern "C" {
__attribute__((import_name("add_security_group_participants"))) int64_t add_security_group_participants(const char* data, uint32_t datalen);

__attribute__((import_name("remove_security_group_participants"))) int64_t remove_security_group_participants(const char* data, uint32_t datalen);

__attribute__((import_name("in_active_security_group"))) bool in_active_security_group(const char* data, uint32_t datalen);

__attribute__((import_name("get_active_security_group"))) uint32_t get_active_security_group(char* data, uint32_t datalen);
}
} // namespace internal_use_do_not_use
