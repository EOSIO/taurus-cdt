...
*/
__attribute__((import_name("add_security_group_participants")))
 ...
 * @return -1 if proposing a new security group was unsuccessful, otherwise returns 0.
*/
__attribute__((import_name("remove_security_group_participants")))
...
*/
__attribute__((import_name("in_active_security_group")))
 ...
 *
*/
__attribute__((import_name("get_active_security_group")))
