...
For a complete example of a smart contract that implements an action which returns a value see the [hello example smart contract](../../examples/hello/src/hello.cpp#L16).

## Next Steps

* Compile the smart contract and deploy it to the EOSIO-Taurus testnet or any EOSIO-Taurus based blockchain.
