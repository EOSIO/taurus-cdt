...
---
You can find the implementation of `eosio::binary_extension` in the EOSIO-Taurus CDT repository in [`binary_extension.hpp`](../../libraries/eosiolib/core/eosio/binary_extension.hpp).
